    ...
    render() {
        ...
        return (
            <View style={{width: '100%', height: '100%', marginTop: 1}}>
                <TouchableOpacity onPress={this.handleAction} style={{backgroundColor: '#627ab4', height: '100%', width: 79, justifyContent: 'center', alignItems: 'center', borderRadius: 7, marginRight: 1}}>
