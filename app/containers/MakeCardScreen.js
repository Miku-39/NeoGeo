...
import MakeCardEditor from '../components/MakeCardEditor'
...
export default class MakeCardScreen extends Component {
    ...
    componentWillMount() {
        ...
        const ticket = {
            ...
            status: '4285215000',
            type: '3589503634000',
            parkingType: '3590481191000',
            nonStandartCarNumber: true
        }
    ...
    save = () => {
        ...
        var fieldsHighlights = {
          ...
          issueReason: !ticket.issueReason,
          carNumber: !ticket.carNumber,
          carModelText: !ticket.carModelText,
          parkingPlace: !ticket.parkingPlace
        }
        ...
        return (
            <Loader message='Сохранение' isLoading={isAdding || fileIsAdding}>
                <MakeCardEditor
                    ...
                    issueReasons={session.issueReasons}
